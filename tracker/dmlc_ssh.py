    ...
    def submit(self):
        def ssh_submit(nworker, nserver, pass_envs):
            ...
            for i in range(nworker + nserver):
                ...
                prog = f'{self.get_env(pass_envs)} cd {working_dir}; {self.cmd}'
                prog = f'ssh -o StrictHostKeyChecking=no {node}' + ' \'' + prog + '\''
